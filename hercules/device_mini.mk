...
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.opengles.version=131072
...
# PRODUCT_PACKAGES += camera.hercules
# PRODUCT_PACKAGES += hdmi.hercules
# PRODUCT_PACKAGES += mhl.hercules
#PRODUCT_PACKAGES += rtk_cec.hercules
# PRODUCT_PACKAGES += hdmi_cec.hercules
# PRODUCT_PACKAGES += tv_input.hercules
# PRODUCT_PACKAGES += hdcp.hercules
PRODUCT_PACKAGES += libhwse.hercules
PRODUCT_PACKAGES += hwcomposer.hercules
...
PRODUCT_PACKAGES += rtk_gpio.hercules
...
PRODUCT_COPY_FILES += device/realtek/hercules/venus_IR_input.kl:system/usr/keylayout/venus_IR_input.kl
PRODUCT_COPY_FILES += device/realtek/hercules/venus_IR_input.kcm:system/usr/keychars/venus_IR_input.kcm

#Wifi Module Mapper
#PRODUCT_COPY_FILES += device/realtek/hercules/wifi_module_list.cfg:system/etc/wifi/wifi_module_list.cfg
PRODUCT_COPY_FILES += device/realtek/hercules/wifi_module_mapper.json:system/etc/wifi/wifi_module_mapper.json
