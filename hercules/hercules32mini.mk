...
$(call inherit-product, device/realtek/hercules/device_mini.mk)
...
PRODUCT_MODEL  := Realtek Hercules 32-bit Mini
PRODUCT_DEVICE := hercules32mini
PRODUCT_NAME   := hercules32mini
PRODUCT_BRAND  := rtk
