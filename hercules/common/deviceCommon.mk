...
PRODUCT_PROPERTY_OVERRIDES += persist.sys.zram_enabled=0
...
# heap size for low ram devices is defined in go_defaults_common.mk
...
PRODUCT_COPY_FILES += device/realtek/hercules/common/ueventd.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc

PRODUCT_COPY_FILES += device/realtek/hercules/common/init.hercules.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.hercules.rc
PRODUCT_COPY_FILES += device/realtek/hercules/common/init.hercules_vmx.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.hercules.rc
PRODUCT_COPY_FILES += device/realtek/hercules/common/init.hercules.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.hercules.usb.rc
PRODUCT_COPY_FILES += device/realtek/hercules/common/init.fschk.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.fschk.rc
PRODUCT_COPY_FILES += device/realtek/hercules/common/init.e2fsck.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.e2fsck.rc

#PRODUCT_COPY_FILES += device/realtek/hercules/common/init.emmc.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.emmc.rc
#PRODUCT_COPY_FILES += device/realtek/hercules/common/init.nand.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.nand.rc
#PRODUCT_COPY_FILES += device/realtek/hercules/common/init.sata.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.sata.rc
#PRODUCT_COPY_FILES += device/realtek/hercules/common/init.vmx.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.vmx.rc
#PRODUCT_COPY_FILES += device/realtek/hercules/common/init.xen.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.xen.rc

### must copy one fstab.herclues only
PRODUCT_COPY_FILES += device/realtek/hercules/common/fstab.hercules.emmc:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.hercules
#PRODUCT_COPY_FILES += device/realtek/hercules/common/fstab.hercules.sata:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.hercules
#PRODUCT_COPY_FILES += device/realtek/hercules/common/fstab.hercules.vmx:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.hercules
#PRODUCT_COPY_FILES += device/realtek/hercules/common/fstab.hercules.xen:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.hercules
ifeq ($(ENABLE_LOW_RAM), true)
PRODUCT_COPY_FILES += device/realtek/hercules/common/fstab.hercules.emmc.lowram:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.hercules.lowram
endif

### must copy one sys.part.rc only
#PRODUCT_COPY_FILES += device/realtek/hercules/common/sys.part.rc.emmc:$(TARGET_COPY_OUT_VENDOR)/etc/sys.part.rc.emmc
#PRODUCT_COPY_FILES += device/realtek/hercules/common/sys.part.rc.sata:$(TARGET_COPY_OUT_VENDOR)/etc/sys.part.rc.sata
#PRODUCT_COPY_FILES += device/realtek/hercules/common/sys.part.rc.vmx:$(TARGET_COPY_OUT_VENDOR)/etc/sys.part.rc.vmx
#PRODUCT_COPY_FILES += device/realtek/hercules/common/sys.part.rc.xen:$(TARGET_COPY_OUT_VENDOR)/etc/sys.part.rc.xen
...
PRODUCT_COPY_FILES += device/realtek/hercules/common/dhcpcd.conf:$(TARGET_COPY_OUT_VENDOR)/etc/dhcpcd/dhcpcd.conf
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs_rtk_audio.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_rtk_audio.xml
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs_rtk_audio_sec.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_rtk_audio_sec.xml
...
PRODUCT_COPY_FILES += device/realtek/hercules/common/mixer_paths.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.xml
PRODUCT_COPY_FILES += device/realtek/hercules/common/content-types.properties:$(TARGET_COPY_OUT_VENDOR)/lib/content-types.properties
ifeq ($(ENABLE_LOW_RAM), true)
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs_google_video_le-1080p.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_video.xml
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs_rtk_video-1080p.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_rtk_video.xml
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs_performance-1080p.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance.xml
else
...
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs_rtk_video.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_rtk_video.xml
PRODUCT_COPY_FILES += device/realtek/hercules/common/media_codecs_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance.xml
endif

# keylayout
PRODUCT_COPY_FILES += device/realtek/hercules/common/venus_IR_input.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/venus_IR_input.kl
#PRODUCT_COPY_FILES += device/realtek/hercules/common/venus_IR_input.kcm:$(TARGET_COPY_OUT_VENDOR)/usr/keychars/venus_IR_input.kcm
PRODUCT_COPY_FILES += device/realtek/hercules/common/gpio_cmd.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/gpio_cmd.kl

# Vendor seccomp policy files for media components:
PRODUCT_COPY_FILES += device/realtek/hercules/common/mediacodec.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy

# For audio policy
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/realtek/hercules/common/audiopolicy,$(TARGET_COPY_OUT_VENDOR)/etc)
# For audio effect
PRODUCT_COPY_FILES += device/realtek/hercules/common/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml
...
#PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/realtek/hercules/common/prebuilt/system,$(TARGET_COPY_OUT_SYSTEM))
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/realtek/hercules/common/prebuilt/root/sbin,$(TARGET_COPY_OUT_ROOT)/sbin)
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/realtek/hercules/common/prebuilt/vendor,$(TARGET_COPY_OUT_VENDOR))

# prebuilt widevine tee files
ifeq ($(ENABLE_TEE_DRM_FLOW),true)
ifeq ($(ENABLE_LOW_RAM),true)
PRODUCT_COPY_FILES += $(LOCAL_PATH)/common/prebuilt/tee/TEEapi_for_1G_ATV/7aaaf200-2450-11e4-abe20002a5d5c51b.ta:$(TARGET_COPY_OUT_VENDOR)/lib/teetz/7aaaf200-2450-11e4-abe20002a5d5c51b.ta
else
PRODUCT_COPY_FILES += $(LOCAL_PATH)/common/prebuilt/tee/TEEapi_for_normal/7aaaf200-2450-11e4-abe20002a5d5c51b.ta:$(TARGET_COPY_OUT_VENDOR)/lib/teetz/7aaaf200-2450-11e4-abe20002a5d5c51b.ta
endif
...
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/realtek/hercules/common/prebuilt/tee/widevine,$(TARGET_COPY_OUT_VENDOR))
endif
...
BOARD_VENDOR_KERNEL_MODULES := $(shell find device/realtek/hercules/common/prebuilt/modules -name "*.ko" -type f)
#PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/realtek/hercules/common/prebuilt/modules,$(TARGET_COPY_OUT_VENDOR)/lib/modules)

# prebuilt mali library
PRODUCT_COPY_FILES += device/realtek/hercules/common/prebuilt/mali/vendor/lib/egl/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg

# prebuilt/dailybuild
#PRODUCT_PACKAGES += ALSADaemon
...
PRODUCT_PACKAGES += hw/gralloc.hercules.so.32
...
PRODUCT_PACKAGES += hw/gralloc.hercules.so.64

PRODUCT_SUPPORTS_VERITY := false
PRODUCT_SUPPORTS_VERITY_FEC := false
PRODUCT_COPY_FILES += device/realtek/hercules/common/fake_kernel:kernel
