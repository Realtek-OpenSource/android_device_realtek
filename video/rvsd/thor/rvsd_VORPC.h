...
#if defined(RVSD_VO_WRITEBACK) || defined(RVSD_USE_V1_SCALE)
...
struct VORPCGlobal
{
    ...
    int v1ScaleWidth;
    int v1ScaleHeight;
    ion_user_handle_t v1ScaleBufIonHandle;
    int v1ScaleBufmmapFd;
    unsigned long v1ScaleBufPhysAddr;
    unsigned int v1ScaleBufSize;
    unsigned char *v1ScaleBufVirtAddr;
    unsigned char *v1ScaleBufPLockAddr;
...
#ifdef RVSD_USE_V1_SCALE
HRESULT rvsd_vo_allocFBForV1Scale(RVSD_INFO *pRvsdInfo, int scaleWidth, int scaleHeight, bool bIs10bit, int nv21, int linearStride);
void rvsd_vo_turnOffV1Scale(RVSD_INFO *pRvsdInfo);
bool rvsd_vo_checkV1ScaleBufUnlock(RVSD_INFO *pRvsdInfo);
void rvsd_vo_freeFBForV1Scale(RVSD_INFO *pRvsdInfo);
#endif  // #ifdef RVSD_USE_V1_SCALE
