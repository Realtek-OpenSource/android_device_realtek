...
#define RTK_RVSD_RUNNING    "vendor.rvsd.running"
...
private:
	...
	void JDecFillYUVData(YUV_STATE* yuv_win, unsigned int dispFramePhyAddr, int indexFrameDisplay, long long outTimestamp, long long RPTS, const void *p_dolby_register);
	void JDecFormat422To420(unsigned int dispFramePhyAddr);
	void JDecSendOneFrameToVO(YUV_STATE* yuv_win, void * pdisplayInfo, long long outTimestamp, long long RPTS, const void *p_dolby_register);
