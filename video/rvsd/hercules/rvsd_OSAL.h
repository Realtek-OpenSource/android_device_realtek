...
#define RVSD_MAX_PRINT_LENGTH   512
#define RVSD_DV_LOG_MASK        (RVSD_BL_LOG_FLAG|RVSD_EL_LOG_FLAG)
#define RVSD_BL_LOG_FLAG        (0x00000001)
#define RVSD_EL_LOG_FLAG        (0x00000002)
...
#define RVSD_SEC(ms, pPrePTS, fmt, args...)\
{\
