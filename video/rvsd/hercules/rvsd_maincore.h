...
#ifdef ANDROID
#ifndef RVSD_VP9_NEW_FLOW
#include "rvsd_VDecACodec.h"
#else 
#include "rvsd_VDecACdec_NewFlow.h"
#endif
...
#if defined(RVSD_USE_TEE) || defined(ENABLE_TEE_DRM_FLOW)
...
//#endif
#if defined(ANDROID) || defined(RVSD_VP9_NEW_FLOW)
    ...
    //RVSD VP9.2 HDR Support
#if defined(ANDROID) || defined(RVSD_VP9_NEW_FLOW)
    RVSD_VP9_HDR_INFO mVP9_HDR_Info;
#endif
    ...
    bool is_svp;
    int linearBufMode;
    struct timeval tvIpcReceived;
    struct timeval tvIpcCompleted;
    
private:
    //static android::Mutex _mlock;
    //static RVSD_INFO* mInstance;
    RVSD *mListener;
    char m_file_path[RVSD_INFO_MAX_PATH];
};
