...
//#define BDSP_DBG_DUMP_DECODED_PIXEL_EN   // debug: dump picture, Android.mk: RVSD_DBG_DUMP_BS = true
...
//#define RVSD_BDSP_YUV4K_2_RGB2K   // defined in Android.mk
...
//#define BDSP_DBG_DUMP_PIC(x) BDSP_dbg_dump_pic_Index(x)
//#define BDSP_DBG_DUMP_PIC(x) BDSP_dbg_dump_pic_argb8888(x)
#else
#define BDSP_DBG_DUMP_PIC(x) 
#endif

#ifdef BDSP_DBG_DUMP_DECODED_PIXEL_EN
#define BDSP_DBG_DUMP_DECODED_PIXEL(a, b, c, d, e) BDSP_dbg_dump_decoded_pixels(a, b, c, d, e)
#else
#define BDSP_DBG_DUMP_DECODED_PIXEL(a, b, c, d, e) 
#endif
...
#define BDSP_ARGB_1920x1088 (0x7f8000 + 0x400)
...
#define BDSP_MAX_PICTURE_WIDTH_3840                  3840
