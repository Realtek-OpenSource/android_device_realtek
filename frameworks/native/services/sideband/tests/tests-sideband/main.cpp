...
void test_surface_producer_consumer()
{
    ...
    // configure window
    status_t err;
native_window_api_connect(mANW.get(), NATIVE_WINDOW_API_RTK_SIDEBAND);
...
{
    property_set("vendor.hwc.v1.force.enable","1");
    property_set("vendor.hwc.v1.force.fullscreen", "1");

    property_set("vendor.hwc.osd.hide.ms", "1000000");
    property_set("vendor.hwc.osd.hide", "1");
