...
public:
    ...
    int GetBufferInfo   (buffer_handle_t handle, int cmd, void *data, unsigned int size);
...
extern "C" {
    ...
    int GrallocWrapper_GetBufferInfo   (GrallocWrapper * pInstance,
            buffer_handle_t handle,
            int cmd, void *data, unsigned int size);
