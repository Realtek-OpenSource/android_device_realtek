...
HRESULT SetAudioSpdifOutputOffMode();
...
void AudioUtil_Init(void);
void AudioUtil_Deinit(void);
int SetAudioSpdifOutputMode(int mode);
int SetAudioSpdifOutputOffMode();
int SetAudioHdmiOutputMode(int mode);
int SetAudioAGCMode(int mode);
int SetAudioForceChannelCtrl(int ctrlBits);
int SetAudioSurroundSoundMode(int ssMode);
