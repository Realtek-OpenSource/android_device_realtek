...
LOCAL_POST_INSTALL_CMD += cp -f $(LOCAL_PATH)/vendor/lib/libclcore.bc $(TARGET_OUT_VENDOR)/lib/ ;
LOCAL_POST_INSTALL_CMD += cp -f $(LOCAL_PATH)/vendor/lib/libclcore_neon.bc $(TARGET_OUT_VENDOR)/lib/ ;
LOCAL_POST_INSTALL_CMD += cp -f $(LOCAL_PATH)/vendor/bin/bcc $(TARGET_OUT_VENDOR)/bin/ ;
include $(BUILD_PREBUILT)
...
#LOCAL_POST_INSTALL_CMD += cp -f $(LOCAL_PATH)/vendor/lib64/libclcore.bc $(TARGET_OUT_VENDOR)/lib64/ ;
#LOCAL_POST_INSTALL_CMD += cp -f $(LOCAL_PATH)/vendor/lib64/libclcore_neon.bc $(TARGET_OUT_VENDOR)/lib64/ ;
include $(BUILD_PREBUILT)
endif
